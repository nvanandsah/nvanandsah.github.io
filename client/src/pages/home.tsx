...
export default function Home() {
  ...
  const patents = [
    ...
    {
      title: "Methods and systems for creating pitched roof",
      organization: "WIPO",
      date: "Jun 2023",
      link: "https://patents.google.com/patent/WO2023111935A1/en?inventor=Navneet+Anand+SAH"
    }
  ];
  ...
  const handleDownloadCV = () => {
    ...
    const pdfUrl = new URL('Navneet CV.pdf', new URL(import.meta.env.BASE_URL ?? './', window.location.href)).toString();
    link.href = pdfUrl;
    link.download = 'Navneet_Anand_Sah_CV.pdf';
